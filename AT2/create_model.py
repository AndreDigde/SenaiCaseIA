...
from regression_train import train_regression, shuffle_and_split_data, save_results, clear_outliers
...
results = []
features_cleared, targets_cleared, _ = clear_outliers(features, targets, 2.5)
